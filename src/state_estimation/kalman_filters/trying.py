...
if __name__ == '__main__':
    ...
    for i in range(250):
        ...
        if i % 10 == 0:
            ...
            plot_covariance((ekf.x[0,0], ekf.x[1,0]), ekf.P[0:2, 0:2], std=3, facecolor='b', alpha=0.08)
            ...
            plot_covariance((ekf.x[0,0], ekf.x[1,0]), ekf.P[0:2, 0:2], std=3, facecolor='g', alpha=0.4)
